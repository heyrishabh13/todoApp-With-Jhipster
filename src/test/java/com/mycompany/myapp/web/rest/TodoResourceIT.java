...
class TodoResourceIT {
    ...
    public static Todo createEntity(EntityManager em) {
        Todo todo = new Todo().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return todo;
    }
    ...
    public static Todo createUpdatedEntity(EntityManager em) {
        Todo todo = new Todo().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return todo;
    }
    ...
    void putExistingTodo() throws Exception {
        ...
        updatedTodo.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
